...
# (CLI: ``python -m syncpipe demo --prediction``).  Default is OFF.
#
...
#   ``syncpipe.dynamic_features.extract_dynamic_features`` — i.e. the SSoT
...
def build_feature_matrix(
    ...
    """
    from syncpipe.feature_definitions import extract_features as _ssot_extract
