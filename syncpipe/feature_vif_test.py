"""
syncpipe.feature_vif_test — feature collinearity / VIF diagnostics.
...
Distinct from :mod:`syncpipe.qc` (raw-signal quality) and
:mod:`syncpipe.association` (coupling). It operates on the EXTRACTED feature
