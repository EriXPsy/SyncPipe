...
FEATURE_STATUS_ROWS: List[Dict[str, object]] = [
    ...
    },
    {
        ...
        "recommended_use": "primary structure descriptor when thresholding is group-comparable; report threshold metadata and definedness",
    ...
    },
    {
        ...
        "enters_primary_fdr": True,
        "default_audit_or_test": "WCC-level IAAFT null (Family L1) plus design controls; enters the primary group-condition FDR family",
        "recommended_use": "primary structure descriptor when thresholding is group-comparable; describe intermittent versus stable coordination patterns cautiously",
