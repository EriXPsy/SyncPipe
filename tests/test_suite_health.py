...
_EXPECTED_SLOW = 70  # +1 cross-dyad seed independence (slow)  # +2 existence-gate NaN sensitivity (marked slow)
_EXPECTED_NOT_SLOW = 478  # +6 round-2 tests +1 param instance  # +9 cross-validation +1 param instance  # +5 defaults guard +2 param instances
